...
export default function Profile() {
  ...
  const pageContent = (
    <div style={{
      padding: mobile ? '70px 16px 100px' : '32px',
      maxWidth: 520,
      margin: '0 auto',
      ...
      <div style={{ ...card, overflow: 'visible' }}>
        ...
        {!editing ? (
          <button onClick={() => setEditing(true)} style={{ ...bigBtn('#3b82f6'), display: 'block', width: '100%', boxSizing: 'border-box' }}>
            ✏️ Edit Profile
          </button>
        ) : (
      ...
      <div style={{ ...card, overflow: 'visible' }}>
        ...
        {!pwOpen ? (
          <button onClick={() => setPwOpen(true)} style={{ ...bigBtn('#3b82f6'), display: 'block', width: '100%', boxSizing: 'border-box' }}>
            🔒 Change Password
          </button>
        ) : (
          <div>
  ...
  return (
    <>
      ...
      <div style={
        mobile
          ? { minHeight: '100vh', background: '#0f172a', overflowY: 'auto' }
          : { marginLeft: 260, minHeight: '100vh', background: '#0f172a' }
      }>
        {pageContent}
      </div>
    </>
